...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'acceptingPatients']) &gt;= 1">extension with URL = 'acceptingPatients': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'acceptingPatients']) &lt;= 1">extension with URL = 'acceptingPatients': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'fromNetwork']) &lt;= 1">extension with URL = 'fromNetwork': maximum cardinality of 'extension' is 1</sch:assert>
